...
import (
	...
	examplev1alpha1 "github.com/varshaprasad96/custom-crd-operator/pkg/apis/example/v1alpha1"
	...
	v1alpha1 "github.com/varshaprasad96/custom-crd-operator/pkg/generated/listers/example/v1alpha1"
...
func (f *memcachedInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&examplev1alpha1.Memcached{}, f.defaultInformer)
}
