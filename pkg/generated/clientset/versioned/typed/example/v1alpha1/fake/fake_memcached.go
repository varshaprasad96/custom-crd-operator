...
var memcachedsResource = schema.GroupVersionResource{Group: "example", Version: "v1alpha1", Resource: "memcacheds"}

var memcachedsKind = schema.GroupVersionKind{Group: "example", Version: "v1alpha1", Kind: "Memcached"}
...
func (c *FakeMemcacheds) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(memcachedsResource, c.ns, name, opts), &v1alpha1.Memcached{})
